 ...
 */
    ...
    int sendRequest(const char* type, Stream * stream, size_t size = 0, const char * multipartFilename = 0, const char * multipartContentType = 0, const char * multipartFieldName = 0);
...
protected:
    ...
    bool writeWithRetry(const uint8_t * data, int len);
